package com.example.restaurantreviewtwo.ui;
...
import com.example.restaurantreviewtwo.R;
import com.example.restaurantreviewtwo.data.response.CustomerReviewsItem;
import com.example.restaurantreviewtwo.data.response.PostReviewResponse;
import com.example.restaurantreviewtwo.data.response.Restaurant;
import com.example.restaurantreviewtwo.data.response.RestaurantResponse;
import com.example.restaurantreviewtwo.data.retrofit.ApiConfig;
import com.example.restaurantreviewtwo.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void postReview(String review) {
        showLoading(true);
        Call<PostReviewResponse> client = ApiConfig.getApiService().postReview(RESTAURANT_ID, "Dafrans", review);
